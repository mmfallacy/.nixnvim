...
4. Inspect the selected diff and relevant surrounding code. Reject secrets, debug artifacts, incomplete renames, accidental files, and chunks that depend on omitted changes.
